...
function Main({ title, placeholder }: { title: string, placeholder?: string }): ReactElement {
...
function After(): ReactElement {
  return <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
    <ChevronUpDownIcon
